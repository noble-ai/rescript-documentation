...
var require_lodash = __commonJS({
  "node_modules/lodash/lodash.js"(exports2, module2) {
    (function() {
      ...
      function baseFindKey(collection, predicate2, eachFunc) {
        var result;
        eachFunc(collection, function(value, key, collection2) {
          if (predicate2(value, key, collection2)) {
            result = key;
            return false;
          }
        });
      ...
      var runInContext = function runInContext2(context) {
        ...
        function baseConformsTo(object, source, props) {
          ...
          while (length--) {
            ...
            if (value === undefined2 && !(key in object) || !predicate2(value)) {
              return false;
            }
          }
          return true;
        ...
        function baseEvery(collection, predicate2) {
          var result2 = true;
          baseEach(collection, function(value, index, collection2) {
            result2 = !!predicate2(value, index, collection2);
            return result2;
          });
          return result2;
        }
        ...
        function baseFilter(collection, predicate2) {
          var result2 = [];
          baseEach(collection, function(value, index, collection2) {
            if (predicate2(value, index, collection2)) {
              result2.push(value);
            }
          });
          return result2;
        }
        function baseFlatten(array, depth, predicate2, isStrict, result2) {
          var index = -1, length = array.length;
          ...
          while (++index < length) {
            ...
            if (depth > 0 && predicate2(value)) {
              if (depth > 1) {
                baseFlatten(value, depth - 1, predicate2, isStrict, result2);
              } else {
        ...
        function createFind(findIndexFunc) {
          return function(collection, predicate2, fromIndex) {
            ...
            if (!isArrayLike(collection)) {
              var iteratee2 = getIteratee(predicate2, 3);
              collection = keys(collection);
              predicate2 = function(key) {
        ...
        function some2(collection, predicate2, guard) {
...
__export(Doc_bs_exports, {
  ...
  Md: () => Md,
  Source: () => Source,
  decodeDocstring: () => decodeDocstring,
...
// node_modules/@nobleai/rescript-prelude/src/String.bs.js
...
function decodeDocstring(x) {
  return map4(Result$1.decodeString(x, "docstring"), function(__x) {
    return split(__x, "\\n");
  });
}
function decodeDocstrings(json, str) {
  return bind2(Result$1.decodeArray(json, "" + str + " array"), function(x) {
    return map4(all(x.map(decodeDocstring)), join);
  });
}
